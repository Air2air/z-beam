...
describe('MetricsCard Search Functionality', () => {
  afterEach(cleanup);
  ...
  it('should clean special characters from search values', () => {
    render(
      <MetricsCard
        title="Complex Value"
        value="$1,234.56 (±0.1%)"
    ...
    const link = screen.getByRole('link');
    // Should clean to "1234.56 0.1"
    expect(link).toHaveAttribute('href', '/search?q=1234.56%200.1');
  });
