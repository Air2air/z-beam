    ...
    <div className="research-page">
      ...
      {data.research?.primary && (
        <SectionContainer
          ...
          radius={true}
        >
          <div className="bg-white dark:bg-gray-800 rounded-lg p-8 border-2 border-green-200 dark:border-green-800">
              ...
              <div>
                ...
                {data.research.primary.citation && (
                  <div className="text-sm bg-blue-50 dark:bg-blue-900/20 p-3 rounded border border-blue-200 dark:border-blue-800">
                    <strong className="text-blue-900 dark:text-blue-200">Source:</strong>{' '}
                    <a 
        ...
        >
          <div className="space-y-4">
            {data.research.sources.map((source: any, index: number) => (
              <div 
                key={index}
                className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden transition-all hover:shadow-lg"
              >
                <button
                      ...
                      {source.geological_context && (
                        <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-lg border border-amber-200 dark:border-amber-800">
                          ...
                          <div className="grid md:grid-cols-2 gap-3 text-sm">
                            <div>
                              <strong className="text-amber-800 dark:text-amber-300">Formation:</strong>
                              <div className="text-gray-700 dark:text-gray-300">
                                {source.geological_context.formation?.replace(/_/g, ' ')}
                              </div>
                            </div>
                            <div>
                              <strong className="text-amber-800 dark:text-amber-300">Typical Locations:</strong>
                              <div className="text-gray-700 dark:text-gray-300">
                                {source.geological_context.typical_locations}
                              </div>
                            </div>
                            <div className="md:col-span-2">
                              <strong className="text-amber-800 dark:text-amber-300">Mineral Composition:</strong>
                              <div className="text-gray-700 dark:text-gray-300">
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-sm text-gray-500">{variation.unit}</div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="bg-purple-50 dark:bg-purple-900/20 p-3 rounded">
                      ...
                      <div className="bg-gray-50 dark:bg-gray-900/50 p-3 rounded">
                        <div className="text-sm font-semibold text-gray-900 dark:text-gray-200 mb-2">
                          Mineral Composition
                        </div>
            ...
            {data.laser_implications.parameter_recommendations && (
              <div className="grid md:grid-cols-2 gap-6">
                {Object.entries(data.laser_implications.parameter_recommendations).map(([param, details]: any) => (
                  ...
                  >
                    <h3 className="text-lg font-semibold mb-3 text-gray-900 dark:text-gray-100 capitalize">
                      {param.replace(/_/g, ' ')}
                    </h3>
                    <div className="space-y-2">
                      {details.optimal !== undefined && (
                        <div className="flex justify-between items-center p-3 bg-green-50 dark:bg-green-900/20 rounded">
                          <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Optimal</span>
                      ...
                      {details.density_scaling && (
                        <div className="text-xs text-purple-600 dark:text-purple-400 bg-purple-50 dark:bg-purple-900/20 p-2 rounded mt-2">
                    ...
                    >
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          ...
                          <strong className="text-gray-900 dark:text-gray-100">{impact.density} kg/m³</strong>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600 dark:text-gray-400">Power:</span>
                          <strong className="text-gray-900 dark:text-gray-100">{impact.recommended_power}W</strong>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600 dark:text-gray-400">Fluence:</span>
                          <strong className="text-gray-900 dark:text-gray-100">{impact.recommended_fluence} J/cm²</strong>
                        </div>
                        <p className="text-gray-600 dark:text-gray-400 mt-3">
                          {impact.notes}
                        </p>
                        {impact.special_considerations && (
                          <div className="bg-red-50 dark:bg-red-900/20 p-2 rounded border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300">
                  ...
                  return (
                    <div key={index}>
                      <div className="flex items-center justify-between mb-1">
                        <span className={`font-medium ${isHighlighted ? 'text-blue-600 dark:text-blue-400' : 'text-gray-700 dark:text-gray-300'}`}>
                          {material.name}
                        </span>
        ...
        >
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            {data.dataset.license && (
              <div className="text-sm text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-900/50 p-4 rounded">
