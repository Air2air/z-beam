...
export const H1: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className = '' }) => (
  <h1 className={`text-4xl font-thin tracking-tight mt-6 mb-2 text-neutral-900 dark:text-neutral-100 ${className}`}>
    {children}
  </h1>
);

export const H2: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className = '' }) => (
  <h2 className={`text-xl font-light tracking-tight mt-6 mb-2 ${className}`}>
    {children}
  </h2>
);

export const H3: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className = '' }) => (
  <h3 className={`text-xl font-extrabold tracking-tight mt-6 mb-2 ${className}`}>
    {children}
  </h3>
);
