...
const getIndustryIcon = (application: string): JSX.Element => {
  ...
  // Aerospace/Aviation
  if (app.includes('aerospace') || app.includes('aviation') || app.includes('aircraft') || app.includes('canopy')) {
    return (
  ...
  // Medical/Healthcare
  if (app.includes('medical') || app.includes('healthcare') || app.includes('pharmaceutical')) {
    return (
      <svg className={iconClass} fill="currentColor" viewBox="0 0 24 24">
  ...
  if (app.includes('electronics') || app.includes('electrical') || app.includes('semiconductor') || app.includes('display')) {
    return (
      <svg className={iconClass} fill="currentColor" viewBox="0 0 24 24">
  ...
  // Marine/Naval
  if (app.includes('marine') || app.includes('ship') || app.includes('naval') || app.includes('window')) {
    return (
      <svg className={iconClass} fill="currentColor" viewBox="0 0 24 24">
  ...
  if (app.includes('architecture') || app.includes('building') || app.includes('construction') || app.includes('facade')) {
    return (
      <svg className={iconClass} fill="currentColor" viewBox="0 0 24 24">
  ...
  if (app.includes('art') || app.includes('sculpture') || app.includes('cultural') || app.includes('heritage') || app.includes('museum') || app.includes('conservation') || app.includes('monument')) {
    return (
      <svg className={iconClass} fill="currentColor" viewBox="0 0 24 24">
  ...
  // Energy/Power/Solar
  if (app.includes('energy') || app.includes('power') || app.includes('solar') || app.includes('renewable') || app.includes('panel')) {
    return (
      <svg className={iconClass} fill="currentColor" viewBox="0 0 24 24">
  ...
  if (app.includes('manufacturing') || app.includes('industrial') || app.includes('factory') || app.includes('production') || app.includes('fabrication')) {
    return (
      <svg className={iconClass} fill="currentColor" viewBox="0 0 24 24">
  ...
  // Food/Beverage
  if (app.includes('food') || app.includes('beverage') || app.includes('processing') || app.includes('equipment')) {
    return (
      <svg className={iconClass} fill="currentColor" viewBox="0 0 24 24">
  ...
  // Research/Laboratory
  if (app.includes('research') || app.includes('laboratory') || app.includes('scientific')) {
    return (
      <svg className={iconClass} fill="currentColor" viewBox="0 0 24 24">
  ...
  // Religious/Church
  if (app.includes('religious') || app.includes('church') || app.includes('temple')) {
    return (
      <svg className={iconClass} fill="currentColor" viewBox="0 0 24 24">
  ...
  // Educational
  if (app.includes('educational') || app.includes('university') || app.includes('school') || app.includes('collection')) {
    return (
      <svg className={iconClass} fill="currentColor" viewBox="0 0 24 24">
  ...
  // Stone/Landscape
  if (app.includes('stone') || app.includes('marble') || app.includes('granite') || app.includes('landscape')) {
    return (
      <svg className={iconClass} fill="currentColor" viewBox="0 0 24 24">
