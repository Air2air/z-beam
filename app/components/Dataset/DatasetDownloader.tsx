// app/components/Dataset/DatasetDownloader.tsx
'use client';
...
/**
 * Unified Dataset Downloader Component
 * 
 * Displays dataset information with download controls using DatasetSection
 */
  ...
  if (loading) {
    return (
      <div className="text-center py-8">
        ...
        <p className="text-sm text-gray-600 mt-2">Loading dataset information...</p>
      </div>
    );
  }
