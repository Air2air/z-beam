        ...
        <div className="flex flex-wrap gap-2">
          {formats.includes('json') && (
            <button
              ...
              className={`flex items-center gap-2 px-2.5 py-1 rounded-lg border transition-all min-h-[40px] ${
                selectedFormat === 'json'
                  ? 'bg-amber-200 border-amber-700300 text-amber-700300'
                  : 'text-amber-700300 border-amber-700300 border-opacity-50 hover:border-opacity-100 hover:bg-amber-100:bg-amber-900/40'
              }`}
            >
              <DatabaseIcon className="w-4 h-4 text-amber-700300" />
          ...
          {formats.includes('csv') && (
            <button
              ...
              className={`flex items-center gap-2 px-2.5 py-1 rounded-lg border transition-all min-h-[40px] ${
                selectedFormat === 'csv'
                  ? 'bg-green-200 border-green-700300 text-green-700300'
                  : 'text-green-700300 border-green-700300 border-opacity-50 hover:border-opacity-100 hover:bg-green-100:bg-green-900/40'
              }`}
            >
              <DatabaseIcon className="w-4 h-4 text-green-700300" />
          ...
          {formats.includes('txt') && (
            <button
              ...
              className={`flex items-center gap-2 px-2.5 py-1 rounded-lg border transition-all min-h-[40px] ${
                selectedFormat === 'txt'
                  ? 'bg-purple-900/60 border-purple-700300 text-purple-700300'
                  : 'text-purple-700300 border-purple-700300 border-opacity-50 hover:border-opacity-100 hover:bg-purple-100:bg-purple-900/40'
              }`}
            >
              <DatabaseIcon className="w-4 h-4 text-purple-700300" />
