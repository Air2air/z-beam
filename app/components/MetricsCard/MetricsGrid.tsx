...
const GRID_LAYOUTS = {
  'auto': 'grid-cols-3 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-7',
  'grid-2': 'grid-cols-3 sm:grid-cols-5',
  'grid-3': 'grid-cols-3 sm:grid-cols-5 lg:grid-cols-6',
  'grid-4': 'grid-cols-3 sm:grid-cols-5 lg:grid-cols-6 xl:grid-cols-7'
} as const;
