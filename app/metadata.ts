...
export const CATEGORY_METADATA: Record<string, CategoryMetadata> = {
  metal: {
    title: 'Metal Laser Cleaning Solutions',
  ...
  "rare-earth": {
    title: 'Rare-Earth Elements Laser Cleaning',
  ...
  ceramic: {
    title: 'Ceramic Laser Cleaning Solutions',
  ...
  composite: {
    title: 'Composite Material Laser Cleaning',
  ...
  semiconductor: {
    title: 'Semiconductor Laser Cleaning Solutions',
  ...
  glass: {
    title: 'Glass Laser Cleaning Solutions',
  ...
  stone: {
    title: 'Stone Laser Cleaning & Restoration',
  ...
  wood: {
    title: 'Wood Laser Treatment & Restoration',
  ...
  masonry: {
    title: 'Masonry Laser Cleaning & Restoration',
  ...
  plastic: {
    title: 'Plastic Laser Cleaning & Processing',
