...
**Field Name**: Use `relationships` (NOT `domain_linkages`)

---

## Issues Summary

The frontmatter files have **2 critical link structure issues** that cause 404 errors:
...
### Issue 2: Wrong URLs (Don't Match IDs)
❌ **Current**: URLs use abbreviated versions or category paths  
✅ **Required**: URLs must use exact ID from target file

```yaml
# Target file: adhesive-residue-tape-marks-contaminant.yaml
# Target ID: adhesive-residue-tape-marks-contamination
...
relationships:
  ...
  - id: adhesive-residue-tape-marks-contamination  # ← Use full ID from target
    title: Adhesive Residue / Tape Marks
    url: /contaminants/adhesive-residue-tape-marks-contamination  # ← Use ID
    image: /images/contaminants/adhesive-residue-tape-marks-contamination.jpg
```
