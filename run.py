...
USER_CONFIG = {
    ...
    "ai_detection_threshold": 25,  # AI detection threshold (25% max)
    "natural_voice_threshold": 25,  # Natural voice threshold (15-25% range)
    ...
    "improvement_temp": 0.7,  # Improvement passes temperature
    "summary_temp": 0.4,  # Summary generation temperature
    "metadata_temp": 0.2,  # Structured metadata temperature
}
