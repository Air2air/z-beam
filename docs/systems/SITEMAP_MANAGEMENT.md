...
1. ✅ Reads all files from `content/components/frontmatter/`
...
1. Create new file: `content/components/frontmatter/titanium-laser-cleaning.yaml`
...
3. Check file permissions in `content/components/frontmatter/`
