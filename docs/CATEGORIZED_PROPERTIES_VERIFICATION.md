...
| `content/components/frontmatter/aluminum-test-categorized.yaml` | ✅ Created | 250+ | Sample Data |
...
# Sample YAML exists
ls -la content/components/frontmatter/aluminum-test-categorized.yaml
✅ File exists (8.5 KB)
```
...
# 4. View sample
cat content/components/frontmatter/aluminum-test-categorized.yaml
...
### Sample Data Files
```
content/components/frontmatter/aluminum-test-categorized.yaml (250+ lines)
