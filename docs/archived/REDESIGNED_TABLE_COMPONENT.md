...
- **Object Fields**: author (displays author name and details)
...
For complex material properties and machine settings, use dedicated components like MetricsCard or MetricsGrid instead.