...
## 🚨 MANDATORY REQUIREMENT FOR AI ASSISTANTS

**❌ NEVER modify frontmatter YAML files directly**

- AI assistants must NOT make frontmatter changes themselves
- AI assistants must NOT add/edit sectionTitle, sectionDescription, or any other frontmatter fields
- All frontmatter updates must be assigned to backend team
- AI role: Document requirements ONLY, implement component changes ONLY

**✅ CORRECT: Create/update documentation with requirements**  
**✅ CORRECT: Update React/TypeScript components**  
**❌ WRONG: Edit .yaml files in frontmatter/ directory**
