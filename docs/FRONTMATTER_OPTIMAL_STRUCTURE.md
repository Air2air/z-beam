...
**Purpose**: Reference guide for normalized frontmatter formatting (generated output)  
**Date**: January 14, 2026  
**Status**: ✅ CANONICAL STRUCTURE

**Source-of-truth**: Frontmatter in this repo is generated by z-beam-generator. Do not hand-edit these files for data fixes; update the generator/source data and re-export.
