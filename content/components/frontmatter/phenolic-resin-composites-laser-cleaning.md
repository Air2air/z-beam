...
author:
  name: Evelyn Wu
  country: Taiwan
  credentials: PhD in Materials Science, Senior Research Scientist at Taiwan Polymer
    Institute
keywords:
...
- material: Carbon fiber composites
  application: Selective cleaning of resin overflow in CFRP manufacturing
- material: Steel molds
  application: Precision removal of cured resin deposits in injection molding tools
images:
  hero:
...
- name: Electronic encapsulation removal
  description: Selective ablation of phenolic resin encapsulants from circuit boards
    without damaging copper traces
environmentalImpact:
- benefit: Reduced solvent use
  description: Eliminates 95% of chemical solvent consumption compared to traditional
    cleaning methods
- benefit: Waste reduction
  description: Produces 80% less hazardous waste by capturing ablated particles with
    filtration systems
- benefit: Energy efficiency
  description: Consumes 40% less energy than thermal decomposition methods for resin
    removal
...
regulatoryStandards:
- code: ISO 11357-3
  description: Plastics - Differential scanning calorimetry (DSC) for phenolic resin
    thermal properties
- code: ASTM D2583
