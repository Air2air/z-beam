...
name: Float Glass
applications:
- industry: Automotive Glass
  useCase: Laser ablation of adhesive residues at 1064 nm, 20–50 W, 50 ns pulses.
...
description: Technical overview of float glass, for laser cleaning applications, and industrial applications.
keywords:
- float glass
- float glass glass
- laser ablation
