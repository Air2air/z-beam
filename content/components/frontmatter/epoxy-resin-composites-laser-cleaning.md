...
- material: Aluminum alloys
  application: Adhesive removal prior to repair operations
- material: Polymer coatings
  application: Selective removal of degraded top layers
images:
  hero:
...
- benefit: Reduced solvent use
  description: Laser cleaning eliminates 95% of chemical solvents traditionally used
- benefit: Waste reduction
  description: Generates 80% less particulate waste compared to mechanical methods
- benefit: Energy efficiency
  description: Consumes 30-50% less energy than thermal decomposition methods
...
regulatoryStandards:
- code: ISO 11357-3
  description: Plastics - Differential scanning calorimetry (DSC) for curing behavior
- code: ASTM D792
  description: Standard test methods for density and specific gravity of plastics
- code: EN 60825-1
