...
properties:
  ...
  tensileStrength: 462 MPa (pure annealed vanadium)
  tensileStrengthNumeric: 462.0
...
regulatoryStandards: ANSI Z136.1 (Laser Safety), ISO 11553 (Laser Processing Machine
  Safety), ASTM E2015 (Laser Cleaning Standard Guide)
author: Todd Dunning
author_object:
  id: 4
  name: Todd Dunning
...
- benefit: Zero chemical waste generation
  description: Eliminates use of hazardous chemical solvents and acids traditionally
    used for vanadium surface cleaning, reducing chemical disposal by 100%
...
technicalSpecifications:
  ...
  wavelength: 1064 nm (primary), 532 nm (optional for higher absorption)
  spotSize: 0.1-2.0 mm
