...
- material: Aluminum alloys
  application: Aerospace component bonding surface preparation
- material: Titanium
  application: Hybrid structure joining in automotive applications
- material: Thermoplastics
  application: Multi-material component assembly in wind turbine blades
images:
  hero:
...
- benefit: Material conservation
  description: Extends CFRP component lifespan by 30-50% through non-destructive cleaning
- benefit: Energy efficiency
  description: Consumes 40-60% less energy than abrasive blasting methods
...
regulatoryStandards:
- code: ISO 14001:2015
  description: Environmental management system standard for sustainable laser processing
- code: EN 60825-1
  description: Laser product safety classification and requirements
- code: Boening BMS 8-276
