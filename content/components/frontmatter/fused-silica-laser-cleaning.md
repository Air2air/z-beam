...
applications:
- industry: Aerospace
  useCase: Surface preparation of fused silica windows using 1064 nm laser, 0.8 J/cm², 50 ns pulses.
  detail: Specific laser cleaning application
- industry: Medical Devices
  useCase: Sterilization of silica components with 266 nm UV laser, 0.3 J/cm².
  detail: Specific laser cleaning application
...
description: Technical overview of fused silica, for laser cleaning applications, and industrial applications.
keywords:
- fused silica
- fused silica glass
- laser ablation
...
images:
  ...
  closeup:
    alt: Microscopic view of fused silica surface after laser treatment showing preserved microstructure
    url: /images/fused-silica-laser-cleaning-closeup.jpg
regulatoryStandards:
