...
applications:
- industry: "Aerospace"
  detail: Removal of thermal barrier coatings
- industry: "Energy"
  detail: Cleaning of gas turbine components
...
description: Technical overview of Ceramic Matrix Composites (CMCs) for laser cleaning applications, including density, wavelength, and industrial applications.
...
chemicalProperties:
  symbol: CE
  formula: Ceramic Matrix Composites (CMCs)
  materialType: composite
properties:
  density: "2.5-3.5 g/cm³"
  meltingPoint: "Above 2000°C"
  thermalConductivity: "10-20 W/m·K"
  laserType: "Pulsed fiber laser"
  wavelength: "1064nm"
  fluenceRange: "1.0–10 J/cm²"
  chemicalFormula: Ceramic Matrix Composites (CMCs)
composition:
- "Ceramic fibers"
- "Ceramic matrix"
compatibility:
- "Metals"
- "Ceramics"
regulatoryStandards: "ISO 11145, ASTM C1275"
images:
  hero:
...
- benefit: "Reduced waste generation"
  description: "Up to 90% less waste compared to mechanical cleaning methods"
- benefit: "Lower energy consumption"
  description: "Energy savings of 50-70% compared to traditional cleaning"
- benefit: "Decreased use of cleaning chemicals"
  description: "Reduction in chemical usage by 95%"
outcomes:
...
- result: "Preservation of material integrity"
  metric: "Less than 0.1% material loss per ASTM C1275"
- result: "Increased component lifespan"
  metric: "Up to 20% increase in service life of cleaned parts"
