{
  ...
  "@type": "Article",
  "headline": "Laser Cleaning of Lead Materials",
  "description": "Advanced laser cleaning techniques for Lead materials, ensuring precision surface treatment while preserving the material's structural integrity.",
  "keywords": [
    "Lead laser cleaning",
    "Lead metal cleaning",
  ...
  "image": [
    {
      ...
      "name": "Lead Laser Cleaning Workbench Before/After Comparison",
      "caption": "Dual workbench photo of Lead object displaying side-by-side before and after laser cleaning results",
      "description": "Split-view workbench photograph showing a Lead object in before (left) and after (right) states, demonstrating the complete transformation achieved through precision laser cleaning treatment",
      "keywords": "Lead laser cleaning, before after comparison, dual photo, workbench view, contamination removal",
    ...
    },
    {
      ...
      "about": {
        ...
        "description": "Precision laser ablation process with controlled parameters for Lead surface treatment"
      }
    }
  ],
  ...
  "mainEntity": {
    ...
    "description": "Industrial laser cleaning process for Lead materials"
  }
}