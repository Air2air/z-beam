{
  ...
  "@type": "Article",
  "headline": "Laser Cleaning of Stucco Materials",
  ...
  "image": [
    {
      ...
      "name": "Stucco Laser Cleaning Workbench Before/After Comparison",
      "caption": "Dual workbench photo of Stucco object displaying side-by-side before and after laser cleaning results",
      "description": "Split-view workbench photograph showing a Stucco object in before (left) and after (right) states, demonstrating the complete transformation achieved through precision laser cleaning treatment",
      "keywords": "Stucco laser cleaning, before after comparison, dual photo, workbench view, contamination removal",
      "representativeOfPage": true
    },
    {
      "@type": "ImageObject", 
      "url": "/images/stucco-laser-cleaning-closeup.jpg",
      ...
      "about": {
        ...
        "description": "Precision laser ablation process with controlled parameters for Stucco surface treatment"
      }
    }
  ],
  ...
  "mainEntity": {
    ...
    "description": "Industrial laser cleaning process for Stucco materials"
  }
}