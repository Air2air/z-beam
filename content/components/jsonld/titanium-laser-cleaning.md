{
  ...
  "@type": "Article",
  "headline": "Laser Cleaning of Titanium Materials",
  "description": "Advanced laser cleaning techniques for Titanium materials, ensuring precision surface treatment while preserving the material's structural integrity.",
  "keywords": [
    "Titanium laser cleaning",
    "Titanium metal cleaning",
  ...
  "image": [
    {
      ...
      "name": "Titanium Laser Cleaning Workbench Before/After Comparison",
      "caption": "Dual workbench photo of Titanium object displaying side-by-side before and after laser cleaning results",
      "description": "Split-view workbench photograph showing a Titanium object in before (left) and after (right) states, demonstrating the complete transformation achieved through precision laser cleaning treatment",
      "keywords": "Titanium laser cleaning, before after comparison, dual photo, workbench view, contamination removal",
    ...
    },
    {
      ...
      "about": {
        ...
        "description": "Precision laser ablation process with controlled parameters for Titanium surface treatment"
      }
    }
  ],
  ...
  "mainEntity": {
    ...
    "description": "Industrial laser cleaning process for Titanium materials"
  }
}