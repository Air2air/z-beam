{
  ...
  "@type": "Article",
  "headline": "Laser Cleaning of Bronze Materials",
  "description": "Advanced laser cleaning techniques for Bronze materials, ensuring precision surface treatment while preserving the material's structural integrity.",
  "keywords": [
    "Bronze laser cleaning",
    "Bronze metal cleaning",
  ...
  "image": [
    {
      ...
      "name": "Bronze Laser Cleaning Workbench Before/After Comparison",
      "caption": "Dual workbench photo of Bronze object displaying side-by-side before and after laser cleaning results",
      "description": "Split-view workbench photograph showing a Bronze object in before (left) and after (right) states, demonstrating the complete transformation achieved through precision laser cleaning treatment",
      "keywords": "Bronze laser cleaning, before after comparison, dual photo, workbench view, contamination removal",
    ...
    },
    {
      ...
      "about": {
        ...
        "description": "Precision laser ablation process with controlled parameters for Bronze surface treatment"
      }
    }
  ],
  ...
  "mainEntity": {
    ...
    "description": "Industrial laser cleaning process for Bronze materials"
  }
}