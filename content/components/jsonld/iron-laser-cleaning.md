{
  ...
  "@type": "Article",
  "headline": "Laser Cleaning of Iron Materials",
  "description": "Advanced laser cleaning techniques for Iron materials, ensuring precision surface treatment while preserving the material's structural integrity.",
  "keywords": [
    "Iron laser cleaning",
    "Iron metal cleaning",
  ...
  "image": [
    {
      ...
      "name": "Iron Laser Cleaning Workbench Before/After Comparison",
      "caption": "Dual workbench photo of Iron object displaying side-by-side before and after laser cleaning results",
      "description": "Split-view workbench photograph showing a Iron object in before (left) and after (right) states, demonstrating the complete transformation achieved through precision laser cleaning treatment",
      "keywords": "Iron laser cleaning, before after comparison, dual photo, workbench view, contamination removal",
    ...
    },
    {
      ...
      "about": {
        ...
        "description": "Precision laser ablation process with controlled parameters for Iron surface treatment"
      }
    }
  ],
  ...
  "mainEntity": {
    ...
    "description": "Industrial laser cleaning process for Iron materials"
  }
}